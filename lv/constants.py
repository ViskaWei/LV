class Constants():
    ...
    Ps = ["[M/H]", "Teff", "Logg", "[C/M]", "[a/M]"]
    Rtag = ["M31G","MWW","MWC","BHB","RHB","DGG"]
    Cs = {"T": "gist_rainbow", "L": "turbo", "F": "plasma", "C": "gist_rainbow", "O":"winter"}
    Cs_ = ["gist_rainbow", "turbo", "plasma", "gist_rainbow", "winter"]
    Wk = Ws.keys()
    Rk = Rs.keys()